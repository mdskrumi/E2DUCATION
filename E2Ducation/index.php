...
<html>
    ...
    <body style="background-color: azure">
        ...
        <div class="fluid-container">
            ...
            <div class="row">
                <div class="col" style="margin-right: 80px"> <span class="float-right"> 
                    <button type="button" class="btn btn-secondary" disabled onclick="location.href='index.php'">Login</button>
                    <button type="button" class="btn btn-primary"  onclick="location.href='signUp.php'">SignUp</button>
                    </span>
                </div>
            </div>
        ...
        <div class="row" style="padding: 40px">
            ...
            <div class="col-sm-4">
                <form action="Database/loginQuery.php" class="was-validated" Method="POST" >
                    
                    <div class="form-group">
                        <label for="userEmail">User Name Or Email:</label>
                        <input type="text" class="form-control" id="userEmail" placeholder="User Name Or Email" name="userEmail" required>
                    </div>
