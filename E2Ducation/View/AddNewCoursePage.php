<?php
    ...
    if($userDetail[4]==0){
    echo "<script type='text/javascript'>alert('You Are Not A Teacher. Be A Teacher First');</script>";
    }
?>
<!DOCTYPE html>
<html>
    <head>
        <title>E2DUCATION Create New Course</title>
        ...
        <div class="fluid-container">
            ...
            <div class="row" style="margin : 20px">
             ...
             <div class="row">
                ...
                <div class="col-sm-4">
                     <form action="../Database/CreateCourseQuery.php?id=<?php echo $userDetail[0]; ?>" class="was-validated" Method="POST" >
