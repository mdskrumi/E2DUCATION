    ...
    <body style="background-color: white;">
        ...
        <div class="fluid-container">
            ...
            <div class="row">
                <div class="col-sm-2"></div>
                <div class="col-sm-8">
                    <a id="addImageLink" href= "AddNewCoursePage.php?id=<?php echo $userDetail[0]; ?>"><img src="../Images/addImage.png" style="width : 100px ; height: 100px" > Create New Course </a></div>
                <div class="col-sm-2"></div>
            </div>
