...
<html>
    <head>
        <title>E2DUCATION Upload a Video</title>
        ...
        <div class="fluid-container">
            ...
            <div class="row" style="margin : 20px">
             ...
             <div class="row">
                ...
                <div class="col-sm-4">
                     <form action="../Database/UploadVideoQuery.php?courseId=<?php echo $courseId; ?>" class="was-validated" Method="POST" enctype="multipart/form-data" >
